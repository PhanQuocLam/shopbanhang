      ...
      <table class="table table-striped b-t b-light">
        ...
        ?>
          ...
          <td><i>{{$i}}</i></td>
            ...
            <td>@if($order_status==2 || $order_status==3)
        ...
        <td colspan="3">
          ...
          {{csrf_field()}}
              <select class="form-control order_details">
                ...
                <option id="{{$or->order_id}}" selected value="1">Chưa xử lý đơn hàng</option>
          ...
          {{csrf_field()}}
              <select class="form-control order_details">
                <option value="0">-----Chọn hình thức đơn hàng-----</option>
                <option id="{{$or->order_id}}" value="1">Chưa xử lý đơn hàng</option>
